...
def parse_opt(known=False):
    ...
    parser.add_argument('--epochs', type=int, default=1200, help='total training epochs')
    ...
    parser.add_argument('--device', default='0,cpu', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
