...
classes = ["WFXB", "DFXB", "Shenji", "Tuijianshengji", "Jidi", "XL", "HSSD", "JKS", "HBSS", "XP","SD", "NJ", "WFSJ", "DFSJ", "Yita", "DFYX", "DFFYT","TJ", "GTH", "TJJM", "TJGTH", "Vic", "NQ", "XDXL", "DFDSJ", "HSFJ", "FJ", "XZDJ", "DLZ", "JSDJ", "PLAY","HSPLAY", "RJDZ", "RMRJ", "QR", "RMRJFJ"]
  # 自己数据集有哪些类别写哪些类，按照顺序
...
data_path = 'E:\VOCtrainval_06-Nov-2007\VOCdevkit\VOC2007\\'  #train/val标签保存地址
